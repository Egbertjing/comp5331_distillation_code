...
model_path="/home/hjingaa/.cache/huggingface/hub/models--HuggingFaceTB--SmolLM2-135M-Instruct"  # Replace with your own model path
...
do
    ...
    CUDA_VISIBLE_DEVICES=2,3 torchrun --master_port=25649 --nproc_per_node 2 \
        ./llm2rec/run_csft.py \
